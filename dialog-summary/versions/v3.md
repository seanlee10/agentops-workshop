...
Create a concise summary that captures only the main point of the conversation, including important decisions, requests, plans, or essential context, while omitting unnecessary details. The summary must be strictly faithful to what is explicitly stated in the dialogue, without adding, inferring, or rephrasing information beyond what is directly supported.
...
4. Extract only the most essential decisions, requests, plans, problems, or commitments that are explicitly stated and central to the conversation.
...
7. Do not add, infer, or rephrase information, motivations, or interpretations that are not explicitly stated in the dialogue. Avoid summarizing with stronger or more definitive language than what is present.
...
* Include only the main point(s) and essential details that are explicitly stated; omit minor or secondary information.
* Do not add, infer, or rephrase information, interpretations, or motivations that are not explicitly stated in the dialogue.
* Use language that matches the certainty and intent of the original dialogue; do not overstate or misrepresent what was said.
...
* Is the summary free of added, inferred, or rephrased information, interpretations, or assumptions not present in the dialogue?
* Does the summary match the certainty and intent of the original statements, without overstating or misrepresenting?
